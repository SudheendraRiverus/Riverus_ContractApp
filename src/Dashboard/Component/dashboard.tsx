...
export default class Dashboard extends Component<Props, State> {
  ...
  componentWillReceiveProps(nextProps: Props) {
    ...
    if (nextProps.initialFileIds !== null) {
      if (
        nextProps.initialFileIds.length > 0 &&
        initialFileIds !== nextProps.initialFileIds
      ) {
    ...
    if (nextProps.filteredFileIds !== null) {
      if (
        ...
        filteredFileIds !== nextProps.filteredFileIds
      ) {
    ...
    return (
      <div className="row">
          ...
          <div className="row">
            ...
            {initialFileIds !== null && initialFileIds.length !== 0 && (
              <div className="col-md-2 mt-4">
                ...
                >
                  <img src="/static_images/upload-btn-img.svg" alt="btn-img" />
                  &nbsp;Upload
                </button>
              </div>
            )}
          ...
          {dashboardLoader ? (
            ...
            <>
              {!(initialFileIds !== null && initialFileIds.length > 0) ? (
                ...
                <>
                  <DashboardQuickLook
                    filter={["Contract type", "Jurisdiction", "Uploaded by"]}
                    jurisdictionLoader={jurisdictionLoader}
                    contractTypeLoader={contractTypeLoader}
                    uploadedByLoader={uploadedByLoader}
                    ...
                    saveDashboardFilters={saveDashboardFilters}
                  />
                  <div className="row">
                      ...
                      <div className="row">
                        <div className="col-md-4">
                          <div className="row">
                            ...
                            >
                              <div className="total-uploads-circle">
                                {" "}
                                {dashboardTableLoader ? (
                                  <NumberLoader />
                                ) : (
                                ...
                                <br />
                                <div className="total-uploads-text">
                                  Total uploads
                                </div>
                              </div>
                            </div>
                          ...
                          <div className="row">
                            ...
                            >
                              <img
                                className="cursor-pointer"
                                src="/static_images/analyse-btn-img.svg"
                                alt="analyse"
                                onClick={() =>
                        ...
                        <div className="col-md-8 pr-5">
                          <div className="row">
                            <div className="col-md-12 table-info mt-4">
                              <div className="row">
                                ...
                                >
                                  {dashboardTableData.length} out of{" "}
                                  ...
                                  <div className="row">
                                    ...
                                    >
                                      {savedFilters.length > 0 && (
                                        <img
                                          className="cursor-pointer"
                                          src="/static_images/remove-filter-icn.svg"
                                          alt="remove-filter"
                                    ...
                                    <div
                                      className="col-md-11 dashboard-tag-scroll"
                          ...
                          <div
                            className="row upload-header-container"
                            style={{ boxShadow: "none", lineHeight: "20px" }}
                          >
                            <div className="col-md-3">Name</div>
                            <div className="col-md-2">Title</div>
                            <div className="col-md-2">Effective Date</div>
                            <div className="col-md-2">Jurisdiction</div>
                                    ...
                                    <React.Fragment key={i}>
                                      ...
                                      >
                                        ...
                                        >
                                          {data.name.length > 20 ? (
                                            <div
                                              className="col-md-3 file-name-style"
                                              onClick={() =>
                                                this.props.history.push(
                                                  "/document/dashboard/" +
                                                    btoa(data.fileId.toString())
                                                )
                                              }
                                            >
                                              <Tooltip
                                          ...
                                          <div
                                            className="col-md-2 uploadedby-style title-style"
                                            style={{ display: "initial" }}
                                          >
                                            {!isNullOrUndefined(data.title) &&
                                            data.title.length > 0 ? (
                                          ...
                                          <div
                                            className="col-md-2 uploadedby-style"
                                            style={{ fontSize: "12px" }}
                                          >
                                            <div className="row">
                                              <div className="col-md-9">
                                                {data.jurisdiction.length >
                                                0 ? (
                                                  data.jurisdiction[0].length >
                                                  20 ? (
                                                    <Tooltip
                                                      title={
                                                        data.jurisdiction[0]
        ...
        <button
          ...
          type="button"
          data-toggle="modal"
          data-target="#analysisTableModal"
          id="analysisTableButton"
        ></button>
      </div>
    );
  }
